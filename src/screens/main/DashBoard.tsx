...
const DashBoard = () => {
  ...
  // Order Status Data
  const pieData = [
    { value: 65, color: '#10B981', text: 'Completed' },
    { value: 20, color: '#F59E0B', text: 'Pending' },
    { value: 15, color: '#EF4444', text: 'Cancelled' },
  ];
        ...
        {/* <View style={styles.quickActionsCard}>
          ...
          <View style={styles.quickActionsGrid}>
            <TouchableOpacity style={styles.actionButton}>
              <View style={[styles.actionIconContainer, { backgroundColor: '#6366F115' }]}>
                <Icon name="plus" size={20} type="solid" color="#6366F1" />
              </View>
              <Text style={styles.actionText}>Add Product</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.actionButton}>
              <View style={[styles.actionIconContainer, { backgroundColor: '#10B98115' }]}>
                <Icon name="edit" size={20} type="solid" color="#10B981" />
              </View>
              <Text style={styles.actionText}>Edit Profile</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.actionButton}>
              <View style={[styles.actionIconContainer, { backgroundColor: '#3B82F615' }]}>
                <Icon name="cog" size={20} type="solid" color="#3B82F6" />
              </View>
              <Text style={styles.actionText}>Settings</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.actionButton}>
              <View style={[styles.actionIconContainer, { backgroundColor: '#8B5CF615' }]}>
                <Icon name="download" size={20} type="solid" color="#8B5CF6" />
              </View>
